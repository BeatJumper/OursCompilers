...
const std::string PlatformArm64::regName[PlatformArm64::maxRegNum] = {
    ...
    "s17", "s18", "s19", "s20", "s21", "s22", "s23", "s24", "s25", "s26", "s27", "s28", "s29", "s30", "s31", "v0",
...
RegVariable * PlatformArm64::intRegVal[PlatformArm64::maxRegNum] = {
    ...
    new RegVariable(FloatType::getTypeFloat(), PlatformArm64::regName[97], 97),
    new RegVariable(FloatType::getTypeFloat(), PlatformArm64::regName[98], 98),
    new RegVariable(FloatType::getTypeFloat(), PlatformArm64::regName[99], 99),
    new RegVariable(FloatType::getTypeFloat(), PlatformArm64::regName[100], 100),
    new RegVariable(FloatType::getTypeFloat(), PlatformArm64::regName[101], 101),
    new RegVariable(FloatType::getTypeFloat(), PlatformArm64::regName[102], 102),
    new RegVariable(FloatType::getTypeFloat(), PlatformArm64::regName[103], 103),
    new RegVariable(FloatType::getTypeFloat(), PlatformArm64::regName[104], 104),
    new RegVariable(FloatType::getTypeFloat(), PlatformArm64::regName[105], 105),
    new RegVariable(FloatType::getTypeFloat(), PlatformArm64::regName[106], 106),
    new RegVariable(FloatType::getTypeFloat(), PlatformArm64::regName[107], 107),
    new RegVariable(FloatType::getTypeFloat(), PlatformArm64::regName[108], 108),
    new RegVariable(FloatType::getTypeFloat(), PlatformArm64::regName[109], 109),
    new RegVariable(FloatType::getTypeFloat(), PlatformArm64::regName[110], 110),
    new RegVariable(FloatType::getTypeFloat(), PlatformArm64::regName[111], 111),
    new RegVariable(FloatType::getTypeFloat(), PlatformArm64::regName[112], 112),
    new RegVariable(FloatType::getTypeFloat(), PlatformArm64::regName[113], 113),
    new RegVariable(FloatType::getTypeFloat(), PlatformArm64::regName[114], 114),
    new RegVariable(FloatType::getTypeFloat(), PlatformArm64::regName[115], 115),
    new RegVariable(FloatType::getTypeFloat(), PlatformArm64::regName[116], 116),
    new RegVariable(FloatType::getTypeFloat(), PlatformArm64::regName[117], 117),
    new RegVariable(FloatType::getTypeFloat(), PlatformArm64::regName[118], 118),
    new RegVariable(FloatType::getTypeFloat(), PlatformArm64::regName[119], 119),
    new RegVariable(FloatType::getTypeFloat(), PlatformArm64::regName[120], 120),
    new RegVariable(FloatType::getTypeFloat(), PlatformArm64::regName[121], 121),
    new RegVariable(FloatType::getTypeFloat(), PlatformArm64::regName[122], 122),
    new RegVariable(FloatType::getTypeFloat(), PlatformArm64::regName[123], 123),
    new RegVariable(FloatType::getTypeFloat(), PlatformArm64::regName[124], 124),
    new RegVariable(FloatType::getTypeFloat(), PlatformArm64::regName[125], 125),
    new RegVariable(FloatType::getTypeFloat(), PlatformArm64::regName[126], 126)};
