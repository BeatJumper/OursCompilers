...
define dso_local void @putch(i32 noundef %0) #0 {
  ...
  %4 = trunc i32 %3 to i8
  %5 = sext i8 %4 to i32
  %6 = call i32 (i8*, ...) @printf(i8* noundef getelementptr inbounds ([3 x i8], [3 x i8]* @.str.1, i64 0, i64 0), i32 noundef %5)
  ret void
}
...
define dso_local float @getfloat() #0 {
  ...
  %2 = call i32 (i8*, ...) @__isoc99_scanf(i8* noundef getelementptr inbounds ([3 x i8], [3 x i8]* @.str.5, i64 0, i64 0), float* noundef %1)
...
10:                                               ; preds = %6
  ...
  %15 = call i32 (i8*, ...) @__isoc99_scanf(i8* noundef getelementptr inbounds ([3 x i8], [3 x i8]* @.str.5, i64 0, i64 0), float* noundef %14)
  br label %16
...
define dso_local void @putfloat(float noundef %0) #0 {
  ...
  %5 = call i32 (i8*, ...) @printf(i8* noundef getelementptr inbounds ([3 x i8], [3 x i8]* @.str.5, i64 0, i64 0), double noundef %4)
  ret void
}
