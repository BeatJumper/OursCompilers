...
@__const.main.c.0 = dso_local constant [3 x [1 x [3 x i32]]] [[1 x [3 x i32]] [[3 x i32] [i32 0, i32 0, i32 0]], [1 x [3 x i32]] [[3 x i32] [i32 0, i32 0, i32 0]], [1 x [3 x i32]] [[3 x i32] [i32 2, i32 1, i32 8]]], align 16
define dso_local i32 @main() #0 {
main_L0:
	%0 = alloca i32, align 4 ; __ret
	store i32 0, i32* %0, align 4
	%1 = alloca [3 x [1 x [3 x i32]]], align 16 ; c
	%2 = bitcast [3 x [1 x [3 x i32]]]* %1 to i8*
	%3 = bitcast [3 x [1 x [3 x i32]]]* @__const.main.c.0 to i8*
	call void @llvm.memcpy.p0i8.p0i8.i64(i8* align 16 %2, i8* align 16 %3, i64 36, i1 false)
	%4 = getelementptr inbounds [3 x [1 x [3 x i32]]], [3 x [1 x [3 x i32]]]* %1, i64 0, i64 2
	...
	%8 = getelementptr inbounds [3 x [1 x [3 x i32]]], [3 x [1 x [3 x i32]]]* %1, i64 0, i64 2
	...
	%12 = getelementptr inbounds [3 x [1 x [3 x i32]]], [3 x [1 x [3 x i32]]]* %1, i64 0, i64 2
